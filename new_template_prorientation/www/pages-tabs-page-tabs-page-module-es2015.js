        ...
        children: [
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ../trail/trail.module */ "./src/app/pages/trail/trail.module.ts")).then(m => m.TrailPageModule)
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => __webpack_require__.e(/*! import() | map-map-module */ "common").then(__webpack_require__.bind(null, /*! ../map/map.module */ "./src/app/pages/map/map.module.ts")).then(m => m.MapPageModule)
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => __webpack_require__.e(/*! import() | orientation-orientation-module */ "default~orientation-orientation-module~pages-orientation-orientation-module").then(__webpack_require__.bind(null, /*! ../orientation/orientation.module */ "./src/app/pages/orientation/orientation.module.ts")).then(m => m.OrientationPageModule)
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        path: '',
                        loadChildren: () => __webpack_require__.e(/*! import() | user-space-user-space-module */ "user-space-user-space-module").then(__webpack_require__.bind(null, /*! ../user-space/user-space.module */ "./src/app/pages/user-space/user-space.module.ts")).then(m => m.UserSpacePageModule)
                    }
                ]
            },
            {
...
/* harmony import */ var _trail_trail_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../trail/trail.module */ "./src/app/pages/trail/trail.module.ts");
...
TabsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _trail_trail_module__WEBPACK_IMPORTED_MODULE_6__["TrailPageModule"],
        ],
        declarations: [
