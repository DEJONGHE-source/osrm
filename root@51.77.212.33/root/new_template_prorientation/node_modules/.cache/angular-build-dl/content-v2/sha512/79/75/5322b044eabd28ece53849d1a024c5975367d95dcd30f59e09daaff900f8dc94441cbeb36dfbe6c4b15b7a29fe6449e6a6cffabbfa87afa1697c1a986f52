...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-app [class.dark-theme]=\"dark\">\n  <ion-split-pane contentId=\"main-content\">\n\n    <ion-menu contentId=\"main-content\">\n      <ion-header>\n        <ion-toolbar color=\"primary\">\n          <ion-title color=\"secondary\">Pro'rientation</ion-title>\n        </ion-toolbar>\n      </ion-header>\n\n      <ion-content color=\"primary\">\n        <ion-list lines=\"none\">\n\n           <ion-menu-toggle *ngIf=\"hideButton == false\" autoHide=\"false\">\n            <ion-item>\n\n              </ion-item>\n            </ion-menu-toggle>\n\n          <ion-menu-toggle autoHide=\"false\">\n            <ion-item [routerLink]=\"'/app/tabs/Trail'\" routerLinkActive=\"true\" routerDirection=\"root\" detail=\"false\" (click)=enableShowFormTrail()>\n                <ion-icon color=\"secondary\" slot=\"start\" [name]=\"'walk'\"></ion-icon>\n                <ion-label color=\"secondary\">Trail</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n\n          <form #distanceForm=\"ngForm\" *ngIf=\"hideFormTrail == false\" (ngSubmit)=\"onClickSubmitTrail(distanceForm)\">\n            <ion-list class=ionlistScss>\n              <ion-item>\n                <ion-label position=\"stacked\" color=\"secondary\">Entrer une distance</ion-label>\n                <ion-input color=\"secondary\" name=\"distanceTrail\" type=\"number\" placeholder=\"distance\" ngModel required></ion-input>\n              </ion-item>\n              <ion-item *ngFor=\"let item of jsonInterest;\">\n                <ion-checkbox color=\"secondary\" checked=\"false\" (click)=\"selectItem(item)\"></ion-checkbox>\n                <ion-label color=\"secondary\" >{{item[2]}}</ion-label>\n              </ion-item>\n            </ion-list>\n            <ion-button class=\"button\" type = \"submit\">Commencer session</ion-button>\n\n          </form>\n\n          <ion-menu-toggle autoHide=\"false\">\n            <ion-item [routerLink]=\"'/app/tabs/Orientation'\" routerLinkActive=\"false\" routerDirection=\"root\" detail=\"false\" (click)=enableShowFormOrientation()>\n                <ion-icon color=\"secondary\" slot=\"start\" [name]=\"'compass'\"></ion-icon>\n                <ion-label color=\"secondary\">Orientation</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n\n          <form #distanceForm=\"ngForm\" *ngIf=\"hideFormOrientation == false\" (ngSubmit)=\"onClickSubmitOrientation(distanceForm)\">\n            <ion-list class=ionlistScss>\n              <ion-item>\n                <ion-label position=\"stacked\" color=\"primary\">Entrer une distance</ion-label>\n                <ion-input name=\"distance\" type=\"number\" placeholder=\"distance\" ngModel required></ion-input>\n              </ion-item>\n              <ion-item *ngFor=\"let item of jsonInterest;\">\n                <ion-checkbox checked=\"false\" (click)=\"selectItem(item)\"></ion-checkbox>\n                <ion-label color=\"secondary\">{{item[2]}}</ion-label>\n              </ion-item>\n            </ion-list>\n            <ion-item>\n              <ion-button type = \"submit\">Commencer session</ion-button>\n            </ion-item>\n          </form>\n\n          <ion-menu-toggle autoHide=\"false\">\n            <ion-item [routerLink]=\"\" routerLinkActive=\"false\" routerDirection=\"root\" detail=\"false\" (click)=disableShowForms()>\n                <ion-icon color=\"secondary\" slot=\"start\" [name]=\"'person'\"></ion-icon>\n                <ion-label color=\"secondary\">Espace personnel</ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n\n          <ion-menu-toggle autoHide=\"false\" *ngFor=\"let p of appPages; let i = index\">\n            <ion-item [routerLink]=\"p.url\" routerLinkActive=\"active\" routerDirection=\"root\" detail=\"false\">\n              <ion-icon color=\"secondary\" slot=\"start\" [name]=\"p.icon\"></ion-icon>\n              <ion-label color=\"secondary\">\n                {{p.title}}\n              </ion-label>\n            </ion-item>\n\n          </ion-menu-toggle>\n\n        </ion-list>\n\n        <ion-list *ngIf=\"isConnected()\" lines=\"none\">\n          <ion-list-header color=\"primary\">\n            <ion-label color=\"secondary\">Compte</ion-label>\n          </ion-list-header>\n\n          <ion-menu-toggle autoHide=\"false\">\n            <ion-item button (click)=\"logout()\" detail=\"false\">\n              <ion-icon color=\"secondary\" slot=\"start\" name=\"log-out\"></ion-icon>\n              <ion-label color=\"secondary\">\n                Déconnexion\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n\n        </ion-list>\n\n        <ion-list *ngIf=\"!isConnected()\" lines=\"none\">\n          <ion-list-header color=\"primary\">\n            <ion-label color=\"secondary\">Compte</ion-label>\n          </ion-list-header>\n\n\n          <ion-menu-toggle autoHide=\"false\" >\n            <ion-item routerLink=\"/login\" routerLinkActive=\"active\" routerDirection=\"root\" detail=\"false\">\n              <ion-icon color=\"secondary\" slot=\"start\" name=\"log-in\"></ion-icon>\n              <ion-label color=\"secondary\">\n                Connexion\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n\n\n\n          <ion-menu-toggle autoHide=\"false\">\n            <ion-item routerLink=\"/register\" routerLinkActive=\"active\" routerDirection=\"root\" detail=\"false\">\n              <ion-icon color=\"secondary\" slot=\"start\" name=\"person-add\"></ion-icon>\n              <ion-label color=\"secondary\">\n                Inscription\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n\n      </ion-content>\n    </ion-menu>\n\n\n    <ion-router-outlet id=\"main-content\"></ion-router-outlet>\n\n  </ion-split-pane>\n\n\n</ion-app>\n";
    /***/
  },
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~pages-map-map-module~pages-orientation-orientation-module~pages-tabs-page-tabs-page-module~p~974a1df1"), __webpack_require__.e("default~pages-tabs-page-tabs-page-module~pages-trail-trail-module"), __webpack_require__.e("pages-tabs-page-tabs-page-module")]).then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-trail-trail-module */
        [__webpack_require__.e("default~pages-map-map-module~pages-orientation-orientation-module~pages-tabs-page-tabs-page-module~p~974a1df1"), __webpack_require__.e("default~pages-tabs-page-tabs-page-module~pages-trail-trail-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/trail/trail.module */
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-orientation-orientation-module */
        [__webpack_require__.e("default~pages-map-map-module~pages-orientation-orientation-module~pages-tabs-page-tabs-page-module~p~974a1df1"), __webpack_require__.e("default~orientation-orientation-module~pages-orientation-orientation-module"), __webpack_require__.e("pages-orientation-orientation-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/orientation/orientation.module */
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() | pages-user-space-user-space-module */
        "user-space-user-space-module").then(__webpack_require__.bind(null,
        /*! ./pages/user-space/user-space.module */
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~pages-map-map-module~pages-orientation-orientation-module~pages-tabs-page-tabs-page-module~p~974a1df1"), __webpack_require__.e("common")]).then(__webpack_require__.bind(null,
  ...
  function srcAppAppComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "ion-item {\n  --transition: unset;\n}\n\n.active {\n  --color: var(--ion-color-primary);\n  --background: rgba(var(--ion-color-primary-rgb), 0.12);\n  --background-hover: rgba(var(--ion-color-primary-rgb), 0.16);\n  --background-focused: rgba(var(--ion-color-primary-rgb), 0.24);\n}\n\n.active ion-icon {\n  color: inherit;\n}\n\n.button {\n  --background: var(--ion-color-primary-button);\n}\n\n.belal {\n  --color: var(--ion-color-primary-writting);\n}\n\n.ionlistScss {\n  max-height: 350px;\n  overflow-y: scroll;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pages_services_authentication_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./pages/services/authentication.service */
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(menu, platform, router, splashScreen, statusBar, storage, swUpdate, toastCtrl, activatedRoute, connectedService) {
        var _this = this;
        ...
        this.distanceSubmit = false;
        this.target = '5000';
        this.distance = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]();
        this.jsonInterest = null;
        this.tickedInterest = new Array();
        this.connected = null;

        this.enableShowFormTrail = function () {
          _this.show().then(function (res) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      for (i = 0; i < this.jsonInterest.length; i++) {
          ...
          _this.hideFormTrail = false;
          _this.hideFormOrientation = true;
        };

        this.enableShowFormOrientation = function () {
          _this.show().then(function (res) {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0,
            /*#__PURE__*/
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      this.jsonInterest = res;
                      _context2.next = 3;
                      return this.storage.set("jsonInterest", this.jsonInterest);
          ...
          _this.hideFormOrientation = false;
          _this.hideFormTrail = true;
        };

        this.disableShowForms = function () {
          _this.hideFormOrientation = true;
          _this.hideFormTrail = true;

          _this.router.navigateByUrl('/app/tabs/Personal');
        };

        this.route = ['/app/tabs/map'];
        this.routePerso = ['/app/tabs/Personal'];
        this.appPages = [{
          title: 'Carte',
          url: ['/app/tabs/map'],
          icon: 'map'
      ...
      _createClass(AppComponent, [{
                            ...
                            switch (_context3.prev = _context3.next) {
                              ...
                              case 5:
                                toast.onDidDismiss().then(function () {
                                  return _this3.swUpdate.activateUpdate();
                                }).then(function () {
        ...
        value: function logout() {
          ...
          this.connectedService.logoutUser().then(function () {
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    _context5.next = 6;
                    return this.storage.set("tickedInterest", this.tickedInterest);
        ...
        key: "onClickSubmitTrail",
        value: function onClickSubmitTrail(form) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    _context6.next = 4;
                    return this.storage.set("distanceCoursePied", form.value.distanceTrail);
                  ...
                  case 6:
                    _context6.next = 8;
                    return window.location.replace("/app/tabs/Trail");
        ...
        key: "onClickSubmitOrientation",
        value: function onClickSubmitOrientation(form) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
              ...
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    this.distanceSubmit = true;
                    _context8.next = 3;
                    return this.storage.set("distanceOrientation", form.value.distance);
                  ...
                  case 5:
                    _context8.next = 7;
                    return window.location.replace("http://localhost:8100/app/tabs/Orientation");
    ...
    AppComponent.ctorParameters = function () {
      return [{
        ...
        type: _pages_services_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticateService"]
      }];
    };
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_6__["MenuController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["Platform"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_7__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_8__["StatusBar"], _ionic_storage__WEBPACK_IMPORTED_MODULE_9__["Storage"], _angular_service_worker__WEBPACK_IMPORTED_MODULE_3__["SwUpdate"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["ToastController"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _pages_services_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticateService"]])], AppComponent);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pages_services_authentication_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./pages/services/authentication.service */
    "./src/app/pages/services/authentication.service.ts");
    /* harmony import */
    ...
    var angularfire2__WEBPACK_IMPORTED_MODULE_17___default =
    /*#__PURE__*/
    __webpack_require__.n(angularfire2__WEBPACK_IMPORTED_MODULE_17__);
    /* harmony import */


    var firebase__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! firebase */
    "./node_modules/firebase/dist/index.cjs.js");
    /* harmony import */


    var firebase__WEBPACK_IMPORTED_MODULE_18___default =
    /*#__PURE__*/
    __webpack_require__.n(firebase__WEBPACK_IMPORTED_MODULE_18__);

    firebase__WEBPACK_IMPORTED_MODULE_18__["initializeApp"](_environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].firebase);
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicModule"].forRoot(), _ionic_storage__WEBPACK_IMPORTED_MODULE_8__["IonicStorageModule"].forRoot(), _angular_fire_auth__WEBPACK_IMPORTED_MODULE_15__["AngularFireAuthModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["ReactiveFormsModule"], angularfire2__WEBPACK_IMPORTED_MODULE_17__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"]), _angular_service_worker__WEBPACK_IMPORTED_MODULE_11__["ServiceWorkerModule"].register('ngsw-worker.js', {
        enabled: _environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].production
      })],
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_10__["AppComponent"]],
      providers: [_ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_4__["InAppBrowser"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _pages_services_authentication_service__WEBPACK_IMPORTED_MODULE_14__["AuthenticateService"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_16__["AngularFirestore"]],
  ...
  /***/
  function srcAppPagesServicesAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function AuthenticateService(afs) {
      ...
      _createClass(AuthenticateService, [{
        ...
        value: function registerUser(value) {
          ...
          return new Promise(function (resolve, reject) {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(value.email, value.password).then(function (res) {
              _this8.afs.collection('/utilisateurs').add({
        ...
        value: function loginUser(value) {
          return firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().setPersistence(firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"].Auth.Persistence.LOCAL).then(function () {
    ...
    AuthenticateService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"]])], AuthenticateService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/adejonghe/cloneStable/osrm/new_template_prorientation/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
